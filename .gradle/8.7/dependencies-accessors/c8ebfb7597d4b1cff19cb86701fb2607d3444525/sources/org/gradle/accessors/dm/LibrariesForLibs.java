...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class DevtoolsPluginAccessors extends PluginFactory {
        private final DevtoolsKspPluginAccessors paccForDevtoolsKspPluginAccessors = new DevtoolsKspPluginAccessors(providers, config);

        public DevtoolsPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of plugins at <b>plugins.devtools.ksp</b>
         */
        public DevtoolsKspPluginAccessors getKsp() {
            return paccForDevtoolsKspPluginAccessors;
        }

    }

    public static class DevtoolsKspPluginAccessors extends PluginFactory  implements PluginNotationSupplier{

        public DevtoolsKspPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>devtools.ksp</b> with plugin id <b>google.symbol.processing</b> and
         * with version reference <b>ksp</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> asProvider() { return createPlugin("devtools.ksp"); }

        /**
         * Plugin provider for <b>devtools.ksp.actual</b> with plugin id <b>com.google.devtools.ksp</b> and
         * with version reference <b>ksp</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getActual() { return createPlugin("devtools.ksp.actual"); }

    }

    public static class KotlinPluginAccessors extends PluginFactory {
        private final KotlinAndroidPluginAccessors paccForKotlinAndroidPluginAccessors = new KotlinAndroidPluginAccessors(providers, config);

        public KotlinPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of plugins at <b>plugins.kotlin.android</b>
         */
        public KotlinAndroidPluginAccessors getAndroid() {
            return paccForKotlinAndroidPluginAccessors;
        }
    ...
    public static class KotlinAndroidPluginAccessors extends PluginFactory  implements PluginNotationSupplier{
        ...
        /**
         * Plugin provider for <b>kotlin.android</b> with plugin id <b>org.jetbrains.kotlinx.benchmark</b> and
        ...
        /**
         * Plugin provider for <b>kotlin.android.actual</b> with plugin id <b>org.jetbrains.kotlin.android</b> and
         * with version reference <b>kotlin</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getActual() { return createPlugin("kotlin.android.actual"); }
